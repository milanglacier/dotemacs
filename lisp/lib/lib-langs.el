...
;;;###autoload (autoload #'my/send-region-to-ess "lib-langs" nil t)
...
;;;###autoload (autoload #'my/send-region-to-python "lib-langs" nil t)
...
;;;###autoload (autoload #'my/markdown-send-region "lib-langs" nil t)
